...
namespace scheduler
{
	...
	public partial class DazaDanychDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteSala(Sala instance);
		...
		public DazaDanychDataContext() : 
				base(global::scheduler.Properties.Settings.Default.dtas_s383964ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DazaDanychDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DazaDanychDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DazaDanychDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DazaDanychDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Onilość_zajęćChanging(int value);
    partial void Onilość_zajęćChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ilość_zajęć", DbType="Int NOT NULL")]
